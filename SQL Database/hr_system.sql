...
INSERT INTO employees (employee_id, name, gender, position, salary, email, department_id)
VALUES (1, "Sibongile Nkosi", "Female", "Software Engineer", 70000.00, "sibongile.nkosi@moderntech.com", 1),
	   (2, "Lungile Moyo", "Male", "HR Manager", 80000.00, "lungile.moyo@moderntech.com", 2),
	   (3, "Thabo Molefe", "Male", "Quality Analyst", 55000.00, "thabo.molefe@moderntech.com", 3),
	   (4, "Keshav Naidoo", "Male", "Sales Representative", 60000.00, "keshav.naidoo@moderntech.com", 4),
	   (5, "Zanele Khumalo", "Female", "Marketing Specialist", 58000.00, "zanele.khumalo@moderntech.com", 5),
	   (6, "Sipho Zulu", "Male", "UI/UX Designer", 65000.00, "sipho.zulu@moderntech.com", 6),
	   (7, "Naledi Moeketsi", "Female", "DevOps Engineer", 72000.00, "naledi.moeketsi@moderntech.com", 7),
	   (8, "Farai Gumbo", "Male", "Content Strategist", 56000.00, "farai.gumbo@moderntech.com", 8),
	   (9, "Karabo Dlamini", "Female", "Accountant", 62000.00, "karabo.dlamini@moderntech.com", 9),
	   (10, "Fatima Patel", "Female", "Customer Support Lead", 58000.00, "fatima.patel@moderntech.com", 10);
...
CREATE TABLE leave_reason_lookup (
    leaveReason_id INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
    leaveReason VARCHAR(100) NOT NULL,
    description VARCHAR(100) NOT NULL
);

INSERT INTO leave_reason_lookup  (leaveReason_id, leaveReason, description)
VALUES (1, "Sick Leave", "Leave for illness"),
       (2, "Personal", "Personal time off"),
	   (3, "Family Responsibility", "Leave due to family matters"),
	   (4, "Vacation", "Time off for vacation"),
	   (5, "Medical Appointment", "Leave for medical appointments"),
	   (6, "Bereavement", "Leave due to the death of a loved one"),
	   (7, "Childcare", "Leave to care for children");      
...
INSERT INTO payroll (pay_id, name, hourly_rate, hours_worked, leave_deductions, final_salary)
VALUES (1, "Sibongile Nkosi", 457.24, 160, 8, 69500.00),
       (2, "Lungile Moyo", 564.29, 150, 10, 79000.00),
	   (3, "Thabo Molefe", 330.12, 170, 4, 54800.00),
	   (4, "Keshav Naidoo", 375.47, 165, 6, 59700.00),
	   (5, "Zanele Khumalo", 378.10, 158, 5, 57850.00),
	   (6, "Sipho Zulu", 390.36, 168, 2, 64800.00),
       (7, "Naledi Moeketsi", 417.44, 175, 3, 71800.00),
       (8, "Farai Gumbo", 350.00, 160, 0, 56000.00),
       (9, "Karabo Dlamini", 410.00, 155, 5, 61500.00),
	   (10, "Fatima Patel", 365.51, 162, 4, 57750.00);
...
VALUES (1, "Lungile Moyo", "lungile.moyo@moderntech.com", "lungilemoyo@1"),
