...
const insertEmployeeCon = async(req,res)=>{
    let {employee_id, name, gender, position, salary, employmentHistory, email, department_id} = req.body

    res.json({employees: await insertEmployee(employee_id, name, gender, position, salary, employmentHistory, email, department_id)})
}
